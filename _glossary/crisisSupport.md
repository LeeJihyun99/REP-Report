...
sources:
    ...
    - reference: [literatureReference, jmir2024]
      usedFor: Literature evidence concerning large language models in mental health and associated safety considerations.
history:
    v1:
        date: 2026-08-10
