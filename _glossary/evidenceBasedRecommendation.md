...
acronym: evidenceBasedRecommendation
type: glossary
synonyms:
...
sources:
    ...
    - reference: [interview, expert_interview, "Q17"]
      usedFor: Literature-review findings emphasizing evidence-based recommendations.
history:
    v1:
        date: 2026-08-10
